...
async function initDatabase() {
  await client.exec(`
    CREATE TABLE IF NOT EXISTS game_states (
      ...
      alchemy_xp INTEGER NOT NULL DEFAULT 0,
      ...
      temperature INTEGER NOT NULL DEFAULT 80,
      ...
      meat_0 INTEGER NOT NULL DEFAULT 0, meat_1 INTEGER NOT NULL DEFAULT 0, meat_2 INTEGER NOT NULL DEFAULT 0, meat_3 INTEGER NOT NULL DEFAULT 0, meat_4 INTEGER NOT NULL DEFAULT 0,
      meat_5 INTEGER NOT NULL DEFAULT 0, meat_6 INTEGER NOT NULL DEFAULT 0, meat_7 INTEGER NOT NULL DEFAULT 0, meat_8 INTEGER NOT NULL DEFAULT 0, meat_9 INTEGER NOT NULL DEFAULT 0,
  ...
  const migrations = [
    ...
    `ALTER TABLE game_states ADD COLUMN cooking_xp INTEGER NOT NULL DEFAULT 0`,
    `ALTER TABLE game_states ADD COLUMN alchemy_xp INTEGER NOT NULL DEFAULT 0`,
    `ALTER TABLE game_states ADD COLUMN meat_0 INTEGER NOT NULL DEFAULT 0`,
    `ALTER TABLE game_states ADD COLUMN meat_1 INTEGER NOT NULL DEFAULT 0`,
    `ALTER TABLE game_states ADD COLUMN meat_2 INTEGER NOT NULL DEFAULT 0`,
    `ALTER TABLE game_states ADD COLUMN meat_3 INTEGER NOT NULL DEFAULT 0`,
    `ALTER TABLE game_states ADD COLUMN meat_4 INTEGER NOT NULL DEFAULT 0`,
    `ALTER TABLE game_states ADD COLUMN meat_5 INTEGER NOT NULL DEFAULT 0`,
    `ALTER TABLE game_states ADD COLUMN meat_6 INTEGER NOT NULL DEFAULT 0`,
    `ALTER TABLE game_states ADD COLUMN meat_7 INTEGER NOT NULL DEFAULT 0`,
    `ALTER TABLE game_states ADD COLUMN meat_8 INTEGER NOT NULL DEFAULT 0`,
    `ALTER TABLE game_states ADD COLUMN meat_9 INTEGER NOT NULL DEFAULT 0`,
